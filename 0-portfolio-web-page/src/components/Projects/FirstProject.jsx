...
const FirstProject = () => {
    return (
        <div className="project-card">
            <div className='project-card-image first'></div>
            <div className="project-card-text">
                <div className='project-card-text-text'>
                    <h4>Porsche Configurator</h4>
                    <p>This project is a car configurator featuring several selections, an image slider that dynamically changes colors based on the color selection, and calculates the total amount in euros (€) based on the configurator selections. Additionally, it transfers to the order page after clicking the "Order" button.</p>
                </div>
                <div className='project-card-text-links'>
                    <p><span className='techStack'>Tech Stack:</span> HTML, CSS and JavaScript</p>
                    <div className="project-links">

                        <a href="./ProjectLinks/1-porsche configurator/index.html" target="_blank">
                            <div>
                        ...
                        <a href="https://github.com/Simasdan/portfolio-projects/tree/main/1-porsche%20configurator" target="_blank">
                            <div>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
